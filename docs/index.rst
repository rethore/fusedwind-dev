...
analysis (MDAO) of wind energy systems, developed jointly by
the Wind Energy Department at the Technical University of Denmark (DTU Wind Energy)
...
For a better overview of all issues and the current progress of the project visit our `Waffle page <https://waffle.io/FUSED-Wind/fusedwind-dev>`_.
